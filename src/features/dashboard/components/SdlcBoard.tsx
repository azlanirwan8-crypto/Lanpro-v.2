...
export const SdlcBoard: React.FC<SdlcBoardProps> = ({
  ...
  return (
    <div className="w-full h-auto bg-slate-900 text-white rounded-[2rem] relative overflow-y-auto no-scrollbar shadow-2xl flex flex-col p-6 md:p-8 min-h-[460px]">
